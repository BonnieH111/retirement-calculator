...
retirement_savings = st.number_input("Current Savings (R)", value=500000)  # 🔴 Changed $ to R  
...
st.write(f"💰 **At retirement, you'll have:** R{future_value:,.2f}")  # 🔴 Changed $ to R  
st.write(f"💸 **You can spend this much per year:** R{withdrawals[0]:,.2f} (and it grows 3% yearly!)")  # 🔴 Changed $ to R  
...
ax.set_ylabel("Annual Income (R)", color='#FF5E00')  # 🔴 Changed $ to R  
st.pyplot(fig)
